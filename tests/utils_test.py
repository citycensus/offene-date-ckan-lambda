...
class TestUtils(object):
    def test_overall_rank(self):
        row = { "dataset_rank": 1, "formats_rank": 1, "open_formats_rank": 1, "last_update_rank": 1, "open_datasets_rank": 1, "category_variance_rank": 1, "start_rank": 1, "category_rank": 1, "update_start_rank": 1, "dataset_score_rank": 1, "category_score_rank": 1}
